...
void main() {
  ...
  test('addTodo failure and rollback', () async {
    ...
    try {
      await container.read(todoListProvider.notifier).addTodo('Tugas Gagal', fail: true);
    } catch (e) {
      // expected error
    }
    ...
    expect(container.read(todoListProvider).value!.any((e) => e.title == 'Tugas Gagal'), isFalse);
  });
}
